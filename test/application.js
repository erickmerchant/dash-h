...
tap.test('throws an error when command is not defined', function (t) {
  ...
  app.run(function (err) {
    t.deepEqual(output.errors(), [ chalk.red('Error: run help to get a list of commands') ])
...
tap.test('errors with too many arguments', function (t) {
  ...
  app.run(function (err) {
    t.deepEqual(output.errors(), [ chalk.red('Error: too many arguments for test') ])
...
tap.test('errors with too few arguments (singular)', function (t) {
  ...
  app.run(function (err) {
    t.deepEqual(output.errors(), [ chalk.red('Error: missing argument (arg2) for test') ])
...
tap.test('errors with too few arguments (plural)', function (t) {
  ...
  app.run(function (err) {
    t.deepEqual(output.errors(), [ chalk.red('Error: missing arguments (arg1, arg2) for test') ])
...
tap.test('gathers errors from commands (thrown)', function (t) {
  ...
  app.run(function (err) {
    t.deepEqual(output.errors(), [ chalk.red('Error: nothing bad happened') ])
